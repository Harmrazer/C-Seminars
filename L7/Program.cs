...
// {
    // if (count > 1) Towers(with, some, on, count - 1);  // пирамидки
...
for (int n = 10; n < 40; n++)
{
    Console. WriteLine($"FibinacciRecursion({n}) = {FibonacciRecursion(n)} frec = {fRec.ToString("### ### ###"), -15}");
    fRec = 0;
}
